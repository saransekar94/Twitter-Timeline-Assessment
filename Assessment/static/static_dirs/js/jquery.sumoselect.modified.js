    ...
    $.fn.SumoSelect = function (options) {
        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                is_multi_sigle_sel :  $(selObj).attr('multipleSingle'),  //if its a multiple select
                select: '',
                caption: '',
                placeholder: '',
                optDiv: '',
                ...
                createElems: function () {
                    ...
                    if(!O.is_multi || !O.is_multi_sigle_sel)settings.okCancelInMulti = false

                    if(O.E.attr('disabled'))
                        O.select.addClass('disabled').removeAttr('tabindex');

                    //if output as csv and is a multiselect.
                    if (settings.outputAsCSV && O.is_multi && O.is_multi_sigle_sel && O.E.attr('name')) {
                    ...
                    if (O.is_multi || O.is_multi_sigle_sel) O.multiSelelect();
                ...
                createLi: function (opt, d) {
                    ...
                    if (O.is_multi || O.is_multi_sigle_sel) li.prepend('<span><i></i></span>');
                    ...
                    if (!O.is_multi_sigle_sel && opt[0].selected)
                ...
                SelAll:function(){
                    var O = this;
                    if(!O.is_multi || !O.is_multi_sigle_sel)return;
                ...
                showOpts: function () {
                    ...
                    if (O.is_floating) {
                        ...
                        if (O.is_multi || O.is_multi_sigle_sel) H = H + parseInt(O.optDiv.css('padding-bottom'));
                ...
                setPstate: function(){
                    var O = this;
                    if (O.is_multi && O.is_multi_sigle_sel && (O.is_floating || settings.okCancelInMulti)){
                        O.Pstate = [];
                ...
                */
                ...
                unload: function () {
                    ...
                    if (settings.outputAsCSV && O.is_multi && O.is_multi_sigle_sel && O.select.find('input.HEMANT123').length) {
